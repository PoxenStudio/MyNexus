-- Initial schema, mirrors storage/sqlite/migrations/0001_init.sql (docs/系统设计文档.md §5.2).
-- Kept in lockstep with the sqlite migration: same tables/columns, only the
-- DATETIME -> TIMESTAMP type name differs (Postgres has no DATETIME type).
