...
const file_mynexus_proto_rawDesc = "" +
	"\n" +
	"\rmynexus.proto\x12\amynexus\"\x8b\x01\n" +
	...
	"tokenCount\x12\x1b\n" +
	"\tvector_id\x18\x06 \x01(\tR\bvectorId\"\xa7\x01\n" +
	...
	"\aresults\x18\x01 \x03(\v2\x1c.mynexus.KeywordSearchResultR\aresults2\xbb\x01\n" +
	"\rWorkerService\x12;\n" +
	...
	"\x04Chat\x12\x14.mynexus.ChatRequest\x1a\x12.mynexus.ChatChunk0\x012\x86\x02\n" +
	...
	"\n" +
	"ReportFail\x12\x14.mynexus.FailRequest\x1a\f.mynexus.Ack\x12N\n" +
...
var file_mynexus_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_mynexus_proto_goTypes = []any{
	(*IngestRequest)(nil),         // 0: mynexus.IngestRequest
	(*IngestAck)(nil),             // 1: mynexus.IngestAck
	(*SearchRequest)(nil),         // 2: mynexus.SearchRequest
	(*SearchResult)(nil),          // 3: mynexus.SearchResult
	(*SearchResponse)(nil),        // 4: mynexus.SearchResponse
	(*ChatMessage)(nil),           // 5: mynexus.ChatMessage
	(*ChatRequest)(nil),           // 6: mynexus.ChatRequest
	(*Citation)(nil),              // 7: mynexus.Citation
	(*CitationList)(nil),          // 8: mynexus.CitationList
	(*ChatChunk)(nil),             // 9: mynexus.ChatChunk
	(*ProgressRequest)(nil),       // 10: mynexus.ProgressRequest
	(*Ack)(nil),                   // 11: mynexus.Ack
	(*BookMeta)(nil),              // 12: mynexus.BookMeta
	(*Chapter)(nil),               // 13: mynexus.Chapter
	(*Chunk)(nil),                 // 14: mynexus.Chunk
	(*CompleteRequest)(nil),       // 15: mynexus.CompleteRequest
	(*FailRequest)(nil),           // 16: mynexus.FailRequest
	(*KeywordSearchRequest)(nil),  // 17: mynexus.KeywordSearchRequest
	(*KeywordSearchResult)(nil),   // 18: mynexus.KeywordSearchResult
	(*KeywordSearchResponse)(nil), // 19: mynexus.KeywordSearchResponse
}
var file_mynexus_proto_depIdxs = []int32{
	3,  // 0: mynexus.SearchResponse.results:type_name -> mynexus.SearchResult
	5,  // 1: mynexus.ChatRequest.messages:type_name -> mynexus.ChatMessage
	7,  // 2: mynexus.CitationList.items:type_name -> mynexus.Citation
	8,  // 3: mynexus.ChatChunk.citations:type_name -> mynexus.CitationList
	12, // 4: mynexus.CompleteRequest.book:type_name -> mynexus.BookMeta
	13, // 5: mynexus.CompleteRequest.chapters:type_name -> mynexus.Chapter
	14, // 6: mynexus.CompleteRequest.chunks:type_name -> mynexus.Chunk
	18, // 7: mynexus.KeywordSearchResponse.results:type_name -> mynexus.KeywordSearchResult
	0,  // 8: mynexus.WorkerService.TriggerIngest:input_type -> mynexus.IngestRequest
	2,  // 9: mynexus.WorkerService.Search:input_type -> mynexus.SearchRequest
	6,  // 10: mynexus.WorkerService.Chat:input_type -> mynexus.ChatRequest
	10, // 11: mynexus.CoreApiService.ReportProgress:input_type -> mynexus.ProgressRequest
	15, // 12: mynexus.CoreApiService.ReportComplete:input_type -> mynexus.CompleteRequest
	16, // 13: mynexus.CoreApiService.ReportFail:input_type -> mynexus.FailRequest
	17, // 14: mynexus.CoreApiService.KeywordSearch:input_type -> mynexus.KeywordSearchRequest
	1,  // 15: mynexus.WorkerService.TriggerIngest:output_type -> mynexus.IngestAck
	4,  // 16: mynexus.WorkerService.Search:output_type -> mynexus.SearchResponse
	9,  // 17: mynexus.WorkerService.Chat:output_type -> mynexus.ChatChunk
	11, // 18: mynexus.CoreApiService.ReportProgress:output_type -> mynexus.Ack
	11, // 19: mynexus.CoreApiService.ReportComplete:output_type -> mynexus.Ack
	11, // 20: mynexus.CoreApiService.ReportFail:output_type -> mynexus.Ack
	19, // 21: mynexus.CoreApiService.KeywordSearch:output_type -> mynexus.KeywordSearchResponse
...
func file_mynexus_proto_init() {
	...
	file_mynexus_proto_msgTypes[9].OneofWrappers = []any{
		(*ChatChunk_Delta)(nil),
